...
namespace DLL.Repos
{
    ...
    public partial class TBL_COURIERINWARD
    {
        public decimal InvoiceInwardID { get; set; }
        ...
        public string IsReadyToProcess { get; set; }
        public Nullable<System.DateTime> ReadyToProcessDate { get; set; }
        public string ReadyToProcessRemark { get; set; }
        public string IsReadyToPayDone { get; set; }
        public Nullable<System.DateTime> ReadyToPayDate { get; set; }
        public string ReadyToPayStatus { get; set; }
        public string IsCompleted { get; set; }
        public Nullable<System.DateTime> CompletedDate { get; set; }
        public string ERP_Ref_No { get; set; }
        public string ERP_Payment_Ref_No { get; set; }
